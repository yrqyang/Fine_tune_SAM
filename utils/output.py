...
def create_video_from_images(image_folder, output_video_path, target_frame_rate=25):
    ...
    output_video = cv2.VideoWriter(output_video_path, fourcc, target_frame_rate, frameSize=None)
